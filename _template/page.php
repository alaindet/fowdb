...
<head>
	...
	<?php require APP_ROOT . '/_includes/ogp.php'; ?>
	...
	<link href="_css/fowdb-style.min.css?20180430" rel="stylesheet" type="text/css" defer>

	<!-- Favicon -->
	<link rel="icon" type="image/png" href="_images/icons/favicon-16x16.png">
</head>

<body>
	<a name="top"></a>
	<div class="container-fluid" id="page-wrapper">
		<?php require APP_ROOT . '/_includes/header.php'; ?>
		<?=$pageContent?>
	</div>
