$(document).ready(function () {
  ...
  var app = {
    ...
    url: {
      autocomplete: window.BASE_URL + '/api/cards/autocomplete/names',
      check: window.BASE_URL + '/api/cards/check/'
    }
  };
  ...
  app.el.form.on('submit', function (event) {
    event.preventDefault();
    var id = app.el.cardId.val();
    $.getJSON(app.url.check + id, null, function (data) {
