<footer>
  <div class="footer-icons">
    <!-- Facebook -->
    <a href="https://www.facebook.com/fowdb" class="link-as-text" target="_blank"><i class="fa fa-facebook-square"></i></a>
    <!-- Contact Us -->
    |&nbsp;<a href="mailto:alain.det@gmail.com" class="link-as-text"><i class="fa fa-envelope"></i></a>
    <!-- Admin -->
