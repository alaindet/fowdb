...
$admin = [
    ...
    ['GET', 'cr/update/{d}',
        'Admin\\GameRulesController','updateForm',$d],

    ['POST','cr/update/{d}',
        'Admin\\GameRulesController','update',$d, ['token']],

    ['GET', 'cr/delete/{d}',
        'Admin\\GameRulesController','deleteForm',$d],

    ['POST','cr/delete/{d}',
        'Admin\\GameRulesController','delete',$d, ['token']],
...
$judge = [
    ...
    ['POST','restrictions/create',
        'Admin\\PlayRestrictionsController','create',null, ['token']],

    ['GET', 'restrictions/update/{d}',
        'Admin\\PlayRestrictionsController','updateForm',$d],

    ['POST','restrictions/update/{d}',
        'Admin\\PlayRestrictionsController','update',$d, ['token']],

    ['GET','restrictions/delete/{d}',
        'Admin\\PlayRestrictionsController','deleteForm',$d],

    ['POST','restrictions/delete/{d}',
        'Admin\\PlayRestrictionsController','delete',$d,['token']],
