...
// Global error handling (https://stackoverflow.com/a/51091503/5653974)
...
// Title, url and image can be changed by specific controllers later
(OpenGraphProtocol::getInstance())
