        ...
        $.ajax({
            ...
            success: function (data, message) {
                ...
                for (var i = 0, len = data.cardsData.length; i < len; i++) {
                    ...
                    // Card HTML content
                    cardsHTML.push("<div class=\"" + cardClass + spoilerClass + "\"><a href='/?p=card&code=" + c.cardcode + "' target='_self'><img src=\"" + c.thumb_path + "\" data-code=\"" + c.cardcode + "\" data-id=\"" + c.id + "\" data-set=\"" + c.setcode + "\" alt=\"" + c.cardname + "\"></a></div>");
                }
